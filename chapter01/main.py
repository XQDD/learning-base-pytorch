...
# 点积（矩阵乘法）
print(np.dot([[1, 2], [2, 3]], [[3, 4, 5], [5, 6, 7]]))
# 更改数组形状
# reshape,-1表示自动计算，不改变向量本身
nd13 = np.arange(10).reshape(2, -1)
print(nd13)
print("按行展平", nd13.ravel())
print("按列展平", nd13.ravel("F"))
print("flatten按行展平", nd13.flatten())

# 去掉一维的
print(np.arange(6).reshape(2, 3, 1, 1).squeeze())
print(np.arange(6).squeeze())

# 参数为下标，原为0,1,2
print(np.arange(24).reshape(2, 3, 4).transpose(2, 1, 0))
